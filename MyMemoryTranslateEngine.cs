...
namespace nppTranslateCS
{
    ...
    {
        //original from https://github.com/databird/npptranslate64
        ...
        */
        ...
        public List<Pair> SinuLanguages()
        {
            List<Pair> langList = new List<Pair>();
            langList.Add(new Pair("chs", "zh-CHS"));
            langList.Add(new Pair("cht", "zh-CHT"));
            langList.Add(new Pair("csy", "cs"));
            langList.Add(new Pair("dan", "da"));
            langList.Add(new Pair("nld", "nl"));
            langList.Add(new Pair("eng", "en"));
            langList.Add(new Pair("fin", "fi"));
            langList.Add(new Pair("fra", "fr"));
            langList.Add(new Pair("deu", "de"));
            langList.Add(new Pair("hun", "hu"));
            langList.Add(new Pair("ind", "id"));
            langList.Add(new Pair("ita", "it"));
            langList.Add(new Pair("jpn", "ja"));
            langList.Add(new Pair("kor", "ko"));
            langList.Add(new Pair("msl", "ms"));
            langList.Add(new Pair("plk", "pl"));
            langList.Add(new Pair("ptb", "pt"));
            langList.Add(new Pair("rom", "ro"));
            langList.Add(new Pair("rus", "ru"));
            langList.Add(new Pair("sky", "sk"));
            langList.Add(new Pair("slv", "sl"));
            langList.Add(new Pair("esp", "es"));
            langList.Add(new Pair("sve", "sv"));
            langList.Add(new Pair("tha", "th"));
            langList.Add(new Pair("trk", "tr"));
            langList.Add(new Pair("vit", "vi"));
